		...
		>
			...
			<div className="flex flex-col justify-between ml-4">
				<h3 className="font-bold text-blue-500">
					{company}
					{isNew && (
						<span className="bg-blue-500 text-blue-100 font-bold m-2 py-1 px-2 rounded-full uppercase text-sm">
							New
						</span>
					)}
					{featured && (
			...
			<div
				className="flex flex-wrap items-center mt-4 mx-4 pt-4 border-t border-gray-500 border-solid lg:ml-auto
			lg:border-0 lg:pt-0 lg:mt-0"
			>
				{tags
					? tags.map((tag) => (
							<span
